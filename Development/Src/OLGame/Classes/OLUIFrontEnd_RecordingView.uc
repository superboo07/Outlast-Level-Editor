/*******************************************************************************
 * OLUIFrontEnd_RecordingView generated by Eliot.UELib using UE Explorer.
 * Eliot.UELib © 2009-2021 Eliot van Uytfanghe. All rights reserved.
 * http://eliotvu.com
 *
 * All rights belong to their respective owners.
 *******************************************************************************/
class OLUIFrontEnd_RecordingView extends OLUIFrontEnd_Screen within OLUIFrontEnd
    config(UI);

var transient name Recording;
var transient GFxObject DescriptionTextArea;
